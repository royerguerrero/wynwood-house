"""
Django settings for wynwood_house project.
...
ROOT_URLCONF = 'wynwood_house.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'wynwood_house/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'wynwood_house.wsgi.application'
